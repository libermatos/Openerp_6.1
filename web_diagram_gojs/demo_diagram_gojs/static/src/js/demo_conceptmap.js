...
**/
openerp.register_gojs_handler("demo.diagram.gojs", "demo_conceptmap", function(self, result, container){
	...
	myDiagram.nodeTemplate =
		$(go.Node, "Auto",  // the whole node panel
			...
			$(go.Shape, "Rectangle",
				{ fill: $(go.Brush, go.Brush.Linear, { 0: "rgb(254, 201, 0)", 1: "rgb(254, 162, 0)" }), stroke: "black" }),
			$(go.TextBlock, { font: "bold 10pt helvetica, bold arial, sans-serif", margin: 4 },
